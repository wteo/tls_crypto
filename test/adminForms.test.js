...
describe('Get Admin Forms', () => {
    ...
    describe('Update Group Form', () => {
        ...
        it('renders a 404 page when the specified group is not found', () => {
        ...
        it('renders the Update Group form with expected arguments when the specified group is found', () => {
    ...
    describe('Add Coin Form', () => {

        it('renders a 404 page when there are no categories or groups', () => {
        ...
        it('renders the Add Coin form with expected arguments when there are categories and groups', () => {
